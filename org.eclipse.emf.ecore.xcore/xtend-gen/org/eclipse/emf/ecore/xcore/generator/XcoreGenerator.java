          ...
          if (_operator_notEquals) {
            {
              ...
              EAnnotation _createGenModelAnnotation = this.createGenModelAnnotation("body", _extractBody);
          ...
          if (_operator_notEquals_1) {
            {
              ...
              EAnnotation _createGenModelAnnotation_1 = this.createGenModelAnnotation("get", _extractBody_1);
          ...
          if (_operator_notEquals_2) {
            {
              ...
              JvmTypeReference _dataType = _mapping_5.getDataType();
              appendable_2.declareVariable(_dataType, "it");
              this.compiler.compile(createBody, appendable_2, null);
              EList<EAnnotation> _eAnnotations_2 = eDataType.getEAnnotations();
              String _string_2 = appendable_2.toString();
              EAnnotation _createGenModelAnnotation_2 = this.createGenModelAnnotation("create", _string_2);
              _eAnnotations_2.add(_createGenModelAnnotation_2);
            }
          }
          XBlockExpression _convertBody = dataType.getConvertBody();
          final XBlockExpression convertBody = _convertBody;
          boolean _operator_notEquals_3 = ObjectExtensions.operator_notEquals(convertBody, null);
          if (_operator_notEquals_3) {
            {
              XcoreAppendable _createAppendable_3 = this.createAppendable();
              final XcoreAppendable appendable_3 = _createAppendable_3;
              JvmTypeReference _typeForName = this.typeReferences.getTypeForName("java.lang.String", dataType);
              appendable_3.declareVariable(_typeForName, "it");
              this.compiler.compile(convertBody, appendable_3, null);
              EList<EAnnotation> _eAnnotations_3 = eDataType.getEAnnotations();
              String _string_3 = appendable_3.toString();
              String _extractBody_2 = this.extractBody(_string_3);
              EAnnotation _createGenModelAnnotation_3 = this.createGenModelAnnotation("convert", _extractBody_2);
              _eAnnotations_3.add(_createGenModelAnnotation_3);
            }
          }
        }
      }
