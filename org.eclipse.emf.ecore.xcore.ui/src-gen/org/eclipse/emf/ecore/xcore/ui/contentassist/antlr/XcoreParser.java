		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXAttributeAccess().getTypeAssignment_2_0(), "rule__XAttribute__TypeAssignment_2_0");
					put(grammarAccess.getXAttributeAccess().getMultiplicityAssignment_3(), "rule__XAttribute__MultiplicityAssignment_3");
