		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXStructuralFeatureAccess().getAlternatives_1_7(), "rule__XStructuralFeature__Alternatives_1_7");
					put(grammarAccess.getXStructuralFeatureAccess().getAlternatives_2(), "rule__XStructuralFeature__Alternatives_2");
					put(grammarAccess.getXStructuralFeatureAccess().getAlternatives_6(), "rule__XStructuralFeature__Alternatives_6");
					put(grammarAccess.getXOperationAccess().getAlternatives_1(), "rule__XOperation__Alternatives_1");
					...
					put(grammarAccess.getXStructuralFeatureAccess().getGroup(), "rule__XStructuralFeature__Group__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_5(), "rule__XStructuralFeature__Group_5__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_6_0(), "rule__XStructuralFeature__Group_6_0__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_6_1(), "rule__XStructuralFeature__Group_6_1__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_6_1_2(), "rule__XStructuralFeature__Group_6_1_2__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_7_0(), "rule__XStructuralFeature__Group_7_0__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_7_1(), "rule__XStructuralFeature__Group_7_1__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_7_2(), "rule__XStructuralFeature__Group_7_2__0");
					put(grammarAccess.getXStructuralFeatureAccess().getGroup_7_3(), "rule__XStructuralFeature__Group_7_3__0");
					put(grammarAccess.getXOperationAccess().getGroup(), "rule__XOperation__Group__0");
					put(grammarAccess.getXOperationAccess().getGroup_1_0(), "rule__XOperation__Group_1_0__0");
					put(grammarAccess.getXOperationAccess().getGroup_1_1(), "rule__XOperation__Group_1_1__0");
					put(grammarAccess.getXOperationAccess().getGroup_2(), "rule__XOperation__Group_2__0");
					put(grammarAccess.getXOperationAccess().getGroup_2_2(), "rule__XOperation__Group_2_2__0");
					put(grammarAccess.getXOperationAccess().getGroup_7(), "rule__XOperation__Group_7__0");
					put(grammarAccess.getXOperationAccess().getGroup_7_1(), "rule__XOperation__Group_7_1__0");
					put(grammarAccess.getXOperationAccess().getGroup_9(), "rule__XOperation__Group_9__0");
					put(grammarAccess.getXOperationAccess().getGroup_9_2(), "rule__XOperation__Group_9_2__0");
					...
					put(grammarAccess.getXStructuralFeatureAccess().getAnnotationsAssignment_0(), "rule__XStructuralFeature__AnnotationsAssignment_0");
					put(grammarAccess.getXStructuralFeatureAccess().getUnorderedAssignment_1_0(), "rule__XStructuralFeature__UnorderedAssignment_1_0");
					put(grammarAccess.getXStructuralFeatureAccess().getUniqueAssignment_1_1(), "rule__XStructuralFeature__UniqueAssignment_1_1");
					put(grammarAccess.getXStructuralFeatureAccess().getReadonlyAssignment_1_2(), "rule__XStructuralFeature__ReadonlyAssignment_1_2");
					put(grammarAccess.getXStructuralFeatureAccess().getTransientAssignment_1_3(), "rule__XStructuralFeature__TransientAssignment_1_3");
					put(grammarAccess.getXStructuralFeatureAccess().getVolatileAssignment_1_4(), "rule__XStructuralFeature__VolatileAssignment_1_4");
					put(grammarAccess.getXStructuralFeatureAccess().getUnsettableAssignment_1_5(), "rule__XStructuralFeature__UnsettableAssignment_1_5");
					put(grammarAccess.getXStructuralFeatureAccess().getDerivedAssignment_1_6(), "rule__XStructuralFeature__DerivedAssignment_1_6");
					put(grammarAccess.getXStructuralFeatureAccess().getIDAssignment_1_7_0(), "rule__XStructuralFeature__IDAssignment_1_7_0");
					put(grammarAccess.getXStructuralFeatureAccess().getResolveProxiesAssignment_1_7_1_0(), "rule__XStructuralFeature__ResolveProxiesAssignment_1_7_1_0");
					put(grammarAccess.getXStructuralFeatureAccess().getContainmentAssignment_1_7_1_1(), "rule__XStructuralFeature__ContainmentAssignment_1_7_1_1");
					put(grammarAccess.getXStructuralFeatureAccess().getLocalAssignment_1_7_2(), "rule__XStructuralFeature__LocalAssignment_1_7_2");
					put(grammarAccess.getXStructuralFeatureAccess().getReferenceAssignment_1_7_3(), "rule__XStructuralFeature__ReferenceAssignment_1_7_3");
					put(grammarAccess.getXStructuralFeatureAccess().getTypeAssignment_2_0(), "rule__XStructuralFeature__TypeAssignment_2_0");
					put(grammarAccess.getXStructuralFeatureAccess().getMultiplicityAssignment_3(), "rule__XStructuralFeature__MultiplicityAssignment_3");
					put(grammarAccess.getXStructuralFeatureAccess().getNameAssignment_4(), "rule__XStructuralFeature__NameAssignment_4");
					put(grammarAccess.getXStructuralFeatureAccess().getDefaultValueLiteralAssignment_5_1(), "rule__XStructuralFeature__DefaultValueLiteralAssignment_5_1");
					put(grammarAccess.getXStructuralFeatureAccess().getOppositeAssignment_6_0_1(), "rule__XStructuralFeature__OppositeAssignment_6_0_1");
					put(grammarAccess.getXStructuralFeatureAccess().getKeysAssignment_6_1_1(), "rule__XStructuralFeature__KeysAssignment_6_1_1");
					put(grammarAccess.getXStructuralFeatureAccess().getKeysAssignment_6_1_2_1(), "rule__XStructuralFeature__KeysAssignment_6_1_2_1");
					put(grammarAccess.getXStructuralFeatureAccess().getGetBodyAssignment_7_0_1(), "rule__XStructuralFeature__GetBodyAssignment_7_0_1");
					put(grammarAccess.getXStructuralFeatureAccess().getSetBodyAssignment_7_1_1(), "rule__XStructuralFeature__SetBodyAssignment_7_1_1");
					put(grammarAccess.getXStructuralFeatureAccess().getIsSetBodyAssignment_7_2_1(), "rule__XStructuralFeature__IsSetBodyAssignment_7_2_1");
					put(grammarAccess.getXStructuralFeatureAccess().getUnsetBodyAssignment_7_3_1(), "rule__XStructuralFeature__UnsetBodyAssignment_7_3_1");
					put(grammarAccess.getXOperationAccess().getAnnotationsAssignment_0(), "rule__XOperation__AnnotationsAssignment_0");
					put(grammarAccess.getXOperationAccess().getUnorderedAssignment_1_0_0(), "rule__XOperation__UnorderedAssignment_1_0_0");
					put(grammarAccess.getXOperationAccess().getUniqueAssignment_1_0_1(), "rule__XOperation__UniqueAssignment_1_0_1");
					put(grammarAccess.getXOperationAccess().getUniqueAssignment_1_1_0(), "rule__XOperation__UniqueAssignment_1_1_0");
					put(grammarAccess.getXOperationAccess().getUnorderedAssignment_1_1_1(), "rule__XOperation__UnorderedAssignment_1_1_1");
					put(grammarAccess.getXOperationAccess().getTypeParametersAssignment_2_1(), "rule__XOperation__TypeParametersAssignment_2_1");
					put(grammarAccess.getXOperationAccess().getTypeParametersAssignment_2_2_1(), "rule__XOperation__TypeParametersAssignment_2_2_1");
					put(grammarAccess.getXOperationAccess().getTypeAssignment_3(), "rule__XOperation__TypeAssignment_3");
					put(grammarAccess.getXOperationAccess().getMultiplicityAssignment_4(), "rule__XOperation__MultiplicityAssignment_4");
					put(grammarAccess.getXOperationAccess().getNameAssignment_5(), "rule__XOperation__NameAssignment_5");
					put(grammarAccess.getXOperationAccess().getParametersAssignment_7_0(), "rule__XOperation__ParametersAssignment_7_0");
					put(grammarAccess.getXOperationAccess().getParametersAssignment_7_1_1(), "rule__XOperation__ParametersAssignment_7_1_1");
					put(grammarAccess.getXOperationAccess().getExceptionsAssignment_9_1(), "rule__XOperation__ExceptionsAssignment_9_1");
					put(grammarAccess.getXOperationAccess().getExceptionsAssignment_9_2_1(), "rule__XOperation__ExceptionsAssignment_9_2_1");
					put(grammarAccess.getXOperationAccess().getBodyAssignment_10(), "rule__XOperation__BodyAssignment_10");
					...
					put(grammarAccess.getXStructuralFeatureAccess().getUnorderedGroup_1(), "rule__XStructuralFeature__UnorderedGroup_1");
					put(grammarAccess.getXStructuralFeatureAccess().getUnorderedGroup_1_7_1(), "rule__XStructuralFeature__UnorderedGroup_1_7_1");
					put(grammarAccess.getXStructuralFeatureAccess().getUnorderedGroup_7(), "rule__XStructuralFeature__UnorderedGroup_7");
				}
			};
		}
